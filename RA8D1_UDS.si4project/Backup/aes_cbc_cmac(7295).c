...
static uint8_t input1[16] = {0x3D,0x2E,0x6D,0xE2,0xA1,0x25,0x17,0xBA,0xC5,0xB3,0x1B,0xBD,0x0E,0x7E,0x3B,0x54};
static uint8_t input2[16] = {0xD0,0xDF,0xAA,0x15,0x88,0xE0,0x4B,0x5B,0x14,0xCE,0x83,0x4E,0x65,0xE6,0x21,0xCD};

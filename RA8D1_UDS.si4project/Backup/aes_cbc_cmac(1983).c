...
static uint8_t input1[16] = {0x66,0xB0,0xCF,0x31,0xF5,0x6A,0xC1,0x6A,0xBF,0x46,0x10,0xDF,0x87,0xA1,0xAE,0x20};
static uint8_t input2[16] = {0xF0,0xB6,0xE5,0x3E,0xA9,0x01,0xFD,0x31,0xE6,0x64,0x81,0xD4,0x23,0x98,0x7C,0xC7};

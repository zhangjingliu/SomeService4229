...
void AES_CBC_CMAC_EncryptData(const uint8_t *i_pPlainText, const uint32_t i_dataLen, uint8_t *o_pCipherText);
void AES_CBC_CMAC_GetRandom(const uint32_t i_needRandomDataLen, uint8_t *o_pRandomDataBuf);

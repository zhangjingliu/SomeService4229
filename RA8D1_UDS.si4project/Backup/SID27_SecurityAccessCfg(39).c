...
#endif
		UDS_ALG_HAL_EncryptData(Uds_Seed, 16, key);
		//UDS_ALG_HAL_DecryptData(pInd, AES_SEED_LEN, Uds_Seed);
		//UDS_IsReceivedKeyRight(pInd, Uds_Seed, AES_SEED_LEN));

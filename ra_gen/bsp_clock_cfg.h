...
#define BSP_CFG_LCDCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL1Q) /* LCDCLK Src: PLL1Q */
...
#define BSP_CFG_OCTA_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL1P) /* OCTASPICLK Src: PLL1P */
...
#define BSP_CFG_OCTA_DIV (BSP_CLOCKS_OCTA_CLOCK_DIV_8) /* OCTASPICLK Div /8 */
